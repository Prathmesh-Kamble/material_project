...
function handleSubmit() {
  if (id===undefined) {
    axios.post("https://65b7d5fa46324d531d559dd7.mockapi.io/product",data)
    .then((res) =>{
      setData(res.data)
Navigate('/login/appbar/producttable')
    });
  } else {
    axios.put("https://65b7d5fa46324d531d559dd7.mockapi.io/product/"+id,data)
    .then((res)=>{
...
function editdata(){
  ...
  axios.get('https://65b7d5fa46324d531d559dd7.mockapi.io/product/'+id)
  .then((res)=>{
    console.log(res.data);
    setData({
...
<br />
    ...
    >
      ...
      <button className='btn btn-primary mt-5'onClick={(e)=>handleSubmit(e)}>Submit</button>
