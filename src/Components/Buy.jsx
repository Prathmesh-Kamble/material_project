...
let order={
 ...
 function Addsumit(){
if( user==="prathmesh"&& pass==="prathmesh"){
localStorage.setItem("username",user);
localStorage.setItem("password",pass);
    
axios.post('https://65b7d5fa46324d531d559dd7.mockapi.io/oradernow',order)
.then((res)=>{
setData(res.data)
console.log(setData);
})
  ...
  return (
    < div>
      ...
      >
            ...
            <Grid item xs container direction="column" spacing={2}>
              ...
              <Grid item>
                ...
                <Box>
                  ...
                  <Button >{data.quantity}{count}</Button>
        ...
        <button className='btn btn-dark ms-5' onClick={handleOpen} >Orader Now </button>
      </Paper>
